...
@section('content')
    <div class="inner-page">
        <form action="{{ route('landlord.warehouses.store') }}" method="POST" enctype="multipart/form-data" class="form">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4 d-none pallet-dimension-other-value">
