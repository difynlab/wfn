	...
	<div class="page">
		<div class="row align-items-center mb-3 mb-md-4">
			<div class="col-12 mb-3 mb-md-0 col-md-8">
				...
				<p class="description">Manage Warehouse details and activities here.</p>
			</div>
            ...
            <div class="col-12">
				<ul class="nav nav-tabs" id="myTab" role="tablist">
					<li class="nav-item" role="presentation">
						<button class="nav-link active" id="warehouses-tab" data-bs-toggle="tab" data-bs-target="#warehouses-tab-pane" type="button" role="tab" aria-controls="warehouses-tab-pane" aria-selected="true"><i class="bi bi-houses"></i> Warehouses</button>
					</li>
					<li class="nav-item" role="presentation">
						<button class="nav-link" id="quotations-tab" data-bs-toggle="tab" data-bs-target="#quotations-tab-pane" type="button" role="tab" aria-controls="quotations-tab-pane" aria-selected="false"><i class="bi bi-envelope"></i>Quotations</button>
					</li>
				</ul>
				...
				<div class="tab-content" id="myTabContent">
					...
					<div class="tab-pane fade" id="quotations-tab-pane" role="tabpanel" aria-labelledby="quotations-tab" tabindex="0">
						<div class="row">
							<div class="col-12">
