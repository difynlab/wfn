...
@section('title', 'Create Warehouse Review')

@section('content')
    <div class="inner-page">
        <form action="{{ route('admin.warehouses.reviews.store', $warehouse) }}" method="POST" enctype="multipart/form-data" class="form">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-12 mb-3 mb-md-4">
                    ...
                    <textarea class="form-control input-field textarea" name="content" id="content" value="{{ old('content') }}" placeholder="Content" rows="5" required>{{ old('content') }}</textarea>
