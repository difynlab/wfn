...
@section('title', 'Create Pallet Service')

@section('content')
    <div class="inner-page">
        <form action="{{ route('admin.pallet-services.store') }}" method="POST" enctype="multipart/form-data" class="form">
            @csrf

            <div class="page-details">
                <p class="title">Add New Pallet Service</p>
                <p class="description">Fill in the details below to create a new pallet service.</p>
            </div>
