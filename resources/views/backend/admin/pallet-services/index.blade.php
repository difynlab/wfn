...
@section('title', 'Pallet Services')

@section('content')
    <div class="page">
        <div class="row align-items-center mb-3 mb-md-4">
            <div class="col-12 mb-3 mb-md-0 col-md-8">
                <p class="title">Pallet Services</p>
                <p class="description">Manage pallet services here.</p>
            </div>
            <div class="col-12 col-md-4 text-end">
                <a href="{{ route('admin.pallet-services.create') }}" class="add-button">
                    <i class="bi bi-plus-lg"></i>
                    Add New Pallet Service
                </a>
            </div>
        </div>
        ...
        <x-backend.delete data="pallet service"></x-backend.delete>
...
@push('after-scripts')
    <script>
        window.moduleRoutes = {
            destroyRoute: "{{ route('admin.pallet-services.destroy', [':id']) }}",
            filterRoute: "{{ route('admin.pallet-services.filter') }}",
            indexRoute: "{{ route('admin.pallet-services.index') }}",
            pageUrl: "{!! $items->url(1) !!}"
        };
    </script>
