...
@section('content')
    <div class="inner-page">
        <form action="{{ route('admin.licenses.store') }}" method="POST" enctype="multipart/form-data" class="form">
            @csrf

            <div class="page-details">
                <p class="title">Add New License</p>
                <p class="description">Fill in the details below to create a new license.</p>
            </div>
