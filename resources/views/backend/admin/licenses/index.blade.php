    ...
    <div class="page">
        <div class="row align-items-center mb-3 mb-md-4">
            <div class="col-12 mb-3 mb-md-0 col-md-8">
                <p class="title">Licenses</p>
                <p class="description">Manage licenses here.</p>
            </div>
            <div class="col-12 col-md-4 text-end">
                <a href="{{ route('admin.licenses.create') }}" class="add-button">
        ...
        <x-backend.delete data="license"></x-backend.delete>
...
@push('after-scripts')
    <script>
        window.moduleRoutes = {
            destroyRoute: "{{ route('admin.licenses.destroy', [':id']) }}",
            filterRoute: "{{ route('admin.licenses.filter') }}",
            indexRoute: "{{ route('admin.licenses.index') }}",
            pageUrl: "{!! $items->url(1) !!}"
        };
    </script>
