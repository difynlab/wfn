    ...
    <div class="page">
        <div class="row align-items-center mb-4">
            <div class="col-8">
                ...
                <p class="description">Manage report details here.</p>
            </div>
        </div>
                    ...
                    <table class="table w-100">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">REASON <i class="bi bi-arrows-vertical sort-icon" data-name="reason" data-order="desc"></i></th>
        ...
        <x-backend.delete data="report"></x-backend.delete>
...
@push('after-scripts')
    <script>
        window.moduleRoutes = {
            destroyRoute: "{{ route('admin.reports.destroy', [':id']) }}",
            filterRoute: "{{ route('admin.reports.filter') }}",
