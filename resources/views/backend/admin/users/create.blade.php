        ...
        <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data" class="form">
            ...
            <div class="row">
                ...
                <div class="col-4 mb-4">
                    ...
                    <input type="number" class="form-control input-field" id="landlord_experience" name="landlord_experience" placeholder="Landlord Experience (Years)" value="{{ old('landlord_experience') }}" min="0">
