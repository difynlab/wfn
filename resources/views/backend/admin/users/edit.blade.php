                ...
                <div class="row form-input">
                    <div class="col-4 mb-4">
                        ...
                        <select class="form-control form-select" id="member" name="member">
                            <option value="Yes" {{ old('member', $user->member) == 'Yes' ? 'selected' : '' }}>Yes</option>
                            <option value="No" {{ old('member', $user->member) == 'No' ? 'selected' : '' }}>No</option>
                        </select>
                    </div>
                    ...
                    <div class="col-4 mb-4 member-type-div d-none">
                        ...
                        <select class="form-control form-select" id="member_type" name="member_type">
                            ...
                            <option value="Lifetime" {{ old('member_type', $user->member_type) == 'Lifetime' ? 'selected' : '' }}>Lifetime</option>
                            <option value="Annual" {{ old('member_type', $user->member_type) == 'Annual' ? 'selected' : '' }}>Annual</option>
                        </select>
                    </div>
                    ...
                    <div class="col-4 mb-4 member-annual-expiry-date-div d-none">
                        ...
                        <input type="date" class="form-control" id="member_annual_expiry_date" name="member_annual_expiry_date" placeholder="Member Annual Expiry Date" value="{{ old('member_annual_expiry_date', $user->member_annual_expiry_date) }}">
                    </div>

                    <div class="col-4 mb-4">
                        <label for="business_name" class="form-label">Business Name</label>
                        <input type="text" class="form-control" id="business_name" name="business_name" placeholder="Business Name" value="{{ old('business_name', $user->business_name) }}">
                    </div>

                    <div class="col-4 mb-4">
                        <label for="business_address" class="form-label">Business Address</label>
                        <input type="text" class="form-control" id="business_address" name="business_address" placeholder="Business Address" value="{{ old('business_address', $user->business_address) }}">
                    </div>

                    <div class="col-4 mb-4">
                        <label for="unit_suite" class="form-label">Unit/ Suite</label>
                        <input type="text" class="form-control" id="unit_suite" name="unit_suite" placeholder="Unit/ Suite" value="{{ old('unit_suite', $user->unit_suite) }}">
                    </div>
                    ...
                    <div class="col-4 mb-4">
                        ...
                        <input type="text" class="form-control" id="state_province" name="state_province" placeholder="State/ Province" value="{{ old('state_province', $user->state_province) }}">
                    </div>

                    <div class="col-4 mb-4">
                        <label for="zip_postal" class="form-label">Zip/ Postal</label>
                        <input type="text" class="form-control" id="zip_postal" name="zip_postal" placeholder="Zip/ Postal" value="{{ old('zip_postal', $user->zip_postal) }}">
                    </div>

                    <div class="col-4 mb-4">
                        <label for="contact_number" class="form-label">Contact Number</label>
                        <input type="text" class="form-control" id="contact_number" name="contact_number" placeholder="Contact Number" value="{{ old('contact_number', $user->contact_number) }}">
                    </div>

                    <div class="col-4 mb-4">
                        <label for="fax" class="form-label">Fax</label>
                        <input type="text" class="form-control" id="fax" name="fax" placeholder="Fax" value="{{ old('fax', $user->fax) }}">
                    </div>

                    <div class="col-4 mb-4">
                        <label for="business_email" class="form-label">Business Email</label>
                        <input type="email" class="form-control" id="business_email" name="business_email" placeholder="Business Email" value="{{ old('business_email', $user->business_email) }}">
                    </div>

                    <div class="col-4 mb-4">
                        <label for="business_secondary_email" class="form-label">Business Secondary Email</label>
                        <input type="email" class="form-control" id="business_secondary_email" name="business_secondary_email" placeholder="Business  Secondary Email" value="{{ old('business_secondary_email', $user->business_secondary_email) }}">
                    </div>
                    ...
                    <div class="col-4 mb-4">
                        ...
                        <select class="form-control form-select" id="age" name="age">
                            ...
                            <option value="29 or younger" {{ old('age', $user->age) == '29 or younger' ? 'selected' : '' }}>29 or younger</option>
                            <option value="30-39" {{ old('age', $user->age) == '30-39' ? 'selected' : '' }}>30-39</option>
                            <option value="40-49" {{ old('age', $user->age) == '40-49' ? 'selected' : '' }}>40-49</option>
                            <option value="50-59" {{ old('age', $user->age) == '50-59' ? 'selected' : '' }}>50-59</option>
                            <option value="60 plus" {{ old('age', $user->age) == '60 plus' ? 'selected' : '' }}>60 plus</option>
                        </select>
                    </div>
                    ...
                    <div class="col-4 mb-4">
                        ...
                        <select class="form-control form-select" id="area_of_interest" name="area_of_interest">
                            ...
                            <option value="Basic and Applied Sciences" {{ old('area_of_interest', $user->area_of_interest) == 'Basic and Applied Sciences' ? 'selected' : '' }}>Basic and Applied Sciences</option>
                            <option value="Medicine" {{ old('area_of_interest', $user->area_of_interest) == 'Medicine' ? 'selected' : '' }}>Medicine</option>
                            <option value="Dietetics" {{ old('area_of_interest', $user->area_of_interest) == 'Dietetics' ? 'selected' : '' }}>Dietetics</option>
                            <option value="Research and Development" {{ old('area_of_interest', $user->area_of_interest) == 'Research and Development' ? 'selected' : '' }}>Research and Development</option>
                            <option value="Health/ Fitness" {{ old('area_of_interest', $user->area_of_interest) == 'Health/ Fitness' ? 'selected' : '' }}>Health/ Fitness</option>
                            <option value="Other" {{ old('area_of_interest', $user->area_of_interest) == 'Other' ? 'selected' : '' }}>Other</option>
                        </select>
                    </div>
                    ...
                    <div class="col-4 mb-4">
                        ...
                        <select class="form-control form-select" id="occupation" name="occupation">
                            ...
                            <option value="Registered Dietitian/ Sport Dietitian" {{ old('occupation', $user->occupation) == 'Registered Dietitian/ Sport Dietitian' ? 'selected' : '' }}>Registered Dietitian/ Sport Dietitian</option>
                            <option value="Academic Professor/ Researcher" {{ old('occupation', $user->occupation) == 'Academic Professor/ Researcher' ? 'selected' : '' }}>Academic Professor/ Researcher</option>
                            <option value="Industry Product Development/ Sales" {{ old('occupation', $user->occupation) == 'Industry Product Development/ Sales' ? 'selected' : '' }}>Industry Product Development/ Sales</option>
                            <option value="Personal Trainer/ Nutritionist" {{ old('occupation', $user->occupation) == 'Personal Trainer/ Nutritionist' ? 'selected' : '' }}>Personal Trainer/ Nutritionist</option>
                            <option value="Private Researcher" {{ old('occupation', $user->occupation) == 'Private Researcher' ? 'selected' : '' }}>Private Researcher</option>
                    ...
                    <div class="col-4 mb-4">
                        ...
                        <select class="form-control form-select" id="messenger_app" name="messenger_app">
                            ...
                            <option value="Skype" {{ old('messenger_app', $user->messenger_app) == 'Skype' ? 'selected' : '' }}>Skype</option>
                            <option value="WeChat" {{ old('messenger_app', $user->messenger_app) == 'WeChat' ? 'selected' : '' }}>WeChat</option>
                            <option value="WhatsApp" {{ old('messenger_app', $user->messenger_app) == 'WhatsApp' ? 'selected' : '' }}>WhatsApp</option>
                        </select>
                    </div>

                    <div class="col-4 mb-4">
                        <label for="messenger_app_id" class="form-label">Messenger App ID</label>
                        <input type="text" class="form-control" id="messenger_app_id" name="messenger_app_id" placeholder="Messenger App ID" value="{{ old('messenger_app_id', $user->messenger_app_id) }}">
                    </div>
                    ...
                    <div class="col-4 mb-4">
                        ...
                        <select class="form-control form-select" id="ad_platform" name="ad_platform">
                            ...
                            <option value="Google" {{ old('ad_platform', $user->ad_platform) == 'Google' ? 'selected' : '' }}>Google</option>
                            <option value="Friend" {{ old('ad_platform', $user->ad_platform) == 'Friend' ? 'selected' : '' }}>Friend</option>
