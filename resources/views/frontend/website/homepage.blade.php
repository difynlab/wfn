                        ...
                        <div class="col-6">
                            ...
                            <form class="form">
                                <div class="row form-row">
                                    <div class="col-9">
                                        <input type="email" class="input" placeholder="{{ $contents->{'section_4_placeholder_' . $middleware_language} ?? $contents->section_4_placeholder_en }}">
                                    </div>
            ...
            <div class="section-5 container section-margin">
                <div class="row">
                    ...
                    <div class="col-4 text-end">
                        <a href="{{ route('frontend.articles.index') }}" class="view-more-button">{{ $contents->{'section_5_button_' . $middleware_language} ?? $contents->section_5_button_en }}</a>
                    </div>
                </div>
            ...
            <div class="section-6">
                <div class="container">
                    <div class="row advertise">
                        ...
                        <div class="col-3">
                            <a href="{{ route('frontend.register') }}" class="advertise-button">{{ $contents->{'section_5_button_' . $middleware_language} ?? $contents->section_5_button_en }}</a>
                        </div>
                    </div>
                </div>
            </div>
