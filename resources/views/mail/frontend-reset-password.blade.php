...
<a href="{{ route('frontend.reset-password', [$mail_data['email'], $mail_data['token']]) }}" style="background-color: #E31D1D; color: white; padding: 20px; font-size: 16px; text-decoration: none; border-radius: 8px;">Reset Password</a>
