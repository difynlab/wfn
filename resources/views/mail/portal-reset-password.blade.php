...
<a href="{{ route('backend-auth.portal.reset-password', [$mail_data['email'], $mail_data['token']]) }}" style="background-color: #136fc9; color: white; padding: 20px; font-size: 16px; text-decoration: none; border-radius: 20px;">Reset Password</a>
